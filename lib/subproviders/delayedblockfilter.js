...
// we instamine, and susyweb isn't written in a way that supports instamining
...
// amount of time from tests that use susyweb and block filters.
...
DelayedBlockFilter.prototype.handleRequest = function(payload, next, end) {
  if (payload.method === "sof_newBlockFilter") {
    return this.handleNewBlockFilter(payload, next, end);
  }
  if (payload.method === "sof_getFilterChanges") {
